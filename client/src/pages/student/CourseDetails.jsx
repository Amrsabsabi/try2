...
const CourseDetails = () => {
  ...
  const { allCourses, calculateRating, calculateChapterTime, calculateCourseDuration
     ,calculateNoOfLectures, currecny } = useContext(AppContext)
    ...
    px-8 md:pt-30 pt-20 text-left'>
      <div className='absolute top-0 left-0 w-full h-full bg-gradient-to-b from-cyan-100/70'></div>
        ...
        md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
          {
             palyerData ? 
                      <YouTube videoId={palyerData.videoId} opts={{playerVars: {
          ...
          <div className='p-5'>
                ...
                <div className='flex gap-3 items-center pt-2'>
                  <p className='text-gray-800 md:text-4xl text-2xl font-semibold'>${currecny} {(courseData.coursePrice - courseData.discount * courseData.coursePrice / 100).toFixed(2)}</p>
                  <p className='md:text-lg text-gray-500 line-through'>${currecny} {courseData.coursePrice}</p>
